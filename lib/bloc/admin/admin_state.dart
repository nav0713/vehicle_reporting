...
class RegisteredVehicleApprovaLUpdateState extends AdminState {}

class AdminRegisteredVehicleViewingState extends AdminState {
  final Vehicle vehicle;
  const AdminRegisteredVehicleViewingState({required this.vehicle});
}

class AdminLoadingState extends AdminState {}

class RegisteredVehicleViewingState extends AdminState {}
